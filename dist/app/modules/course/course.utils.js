...
const findLastCourseId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastCourseId = yield course_model_1.Course.findOne({}, { snid: 1, _id: 0 })
        .sort({ createdAt: -1 })
        .lean();
    return (lastCourseId === null || lastCourseId === void 0 ? void 0 : lastCourseId.snid) ? lastCourseId.snid : undefined;
});
exports.findLastCourseId = findLastCourseId;
const generateCourseId = () => __awaiter(void 0, void 0, void 0, function* () {
    const currentId = (yield (0, exports.findLastCourseId)()) || (0).toString().padStart(5, '0');
    // increment by 1
