...
const createModerator = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _b = req.body, { moderator } = _b, userData = __rest(_b, ["moderator"]);
    userData.email = moderator === null || moderator === void 0 ? void 0 : moderator.email;
    const result = yield user_service_1.UserService.createModerator(moderator, userData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const createAdmin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    userData.email = admin === null || admin === void 0 ? void 0 : admin.email;
